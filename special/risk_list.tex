{\footnotesize
\begin{longtable}{| p{2.5cm} | p{2cm} | p{2cm} | p{2cm} | p{3cm} | p{3cm} |}\hline
	\textbf{Description} & \textbf{Likelihood (1-9)} & \textbf{Impact (1-9)} & \textbf{Importance} & \textbf{Preventive action} & \textbf{Remedial action} \\
	\\\hline
