...
\subsection{Roles and responsibilities (tentative)}
...
\subsection{Example of status report}
...
\subsubsection{Interactions with the customer}
...
\subsubsection{Interactions with the supervisor}
...
\subsubsection{Interactions within the group}
