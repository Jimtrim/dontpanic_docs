...
% \end{itemize}
\subsection{Black Box tests and results}
...
\end{figure}
\noindent Because the customer was going away for two weeks and exams were approaching, this test was done before the system was finished. This affected the test results.\\

\noindent These are the results from the system usability test with the customer:
\begin{enumerate} \setlength{\itemsep}{0cm}\setlength{\parskip}{0cm}
...
\subsection{Usability tests and result}
